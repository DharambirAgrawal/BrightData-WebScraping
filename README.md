...
- **`client/`** — a Next.js app with a scraper module for Amazon product pages, routed through Bright Data's residential proxy network. The UI (a source picker for Amazon / Google / SkyScanner) is a work in progress — Amazon is the only scraper wired up.
